...
function App() {
  ...
  // 🔥 UPDATED: 13 Speaker Flyers (2 featured + 11 others)
  const speakersOthers = [
    ...
    { id: 13, title: "Speaker 13", image: "/speaker-flyer13.jpg" },   // ← New 13th flyer added here
  ];
  ...
  return (
    <div className="min-h-screen bg-zinc-50 font-sans">
      ...
      {/* Meet Our Speakers - 13 FLYERS TOTAL */}
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          {!showSpeakers && (
            <p className="text-zinc-500 italic mt-8">
              Click "Show Others" above to see the remaining 11 speakers
            </p>
          )}
        </div>
      </section>
