...
function App() {
  ...
  // 🔥 UPDATED: 14 Speaker Flyers (2 featured + 12 others)
  const speakersOthers = [
    ...
    { id: 12, title: "Speaker 12", image: "/speaker-flyer12.jpg" },
    { id: 13, title: "Speaker 13", image: "/speaker-flyer13.jpg" },
    { id: 14, title: "Speaker 14", image: "/speaker-flyer14.jpg" },   // ← NEW 14th flyer added here
  ];
  ...
  return (
    <div className="min-h-screen bg-zinc-50 font-sans">
      ...
      {/* Meet Our Speakers - 14 FLYERS TOTAL */}
        ...
        <div className="max-w-7xl mx-auto px-6 text-center">
          ...
          {!showSpeakers && (
            <p className="text-zinc-500 italic mt-8">
              Click "Show Others" above to see the remaining 12 speakers
            </p>
          )}
        </div>
      </section>
